...
class ScenePaths:
	...
	const LEVEL_WIDGET : PackedScene = preload("res://scenes/ui/widgets/level_widget.tscn")
...
class Scenes:
	## 菜单场景
	const MENU := "res://scenes/menu_screen.tscn"
	## 角色选择场景
	const CHARACTER_SELECT := "res://scenes/select_cha_scene.tscn"
	## 关卡选择场景
	const LEVEL_SELECT := "res://scenes/select_level_scene.tscn"
	## 主菜单场景
	const MAIN_MENU := "res://scenes/ui/main_menu.tscn"
	## 游戏场景
	const GAME := "res://scenes/ui/game.tscn"
	## 角色选择场景
	const CHARACTER_SELECT_UI := "res://scenes/ui/character_select.tscn"
	## 关卡选择场景
...
class Effects:
	## 分数漂字效果
	const FLOATING_SCORE := "res://scenes/ui/floating_score.tscn"

## 角色路径
class Characters:
	## 面具小子
	const MASK_DUDE := "res://scenes/characters/player_character/mask_dude.tscn"
	## 忍者蛙
	const NINJA_FROG := "res://scenes/characters/player_character/ninja_frog.tscn"
	## 粉红人
	const PINK_MAN := "res://scenes/characters/player_character/pink_man.tscn"
	## 虚拟人
	const VIRTUAL_GUY := "res://scenes/characters/player_character/virtual_guy.tscn"
